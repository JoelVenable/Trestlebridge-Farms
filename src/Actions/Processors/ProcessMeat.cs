    ...
    public class ProcessMeat
    {
        public static void CollectInput(Farm farm)
        {
            do
            {
                ...
                // Select a field
                IMeatFacility selectedFacility = SelectFacility(farm);
            ...
            } while (AddMore(farm.MeatProcessor.Capacity));

            farm.MeatProcessor.Process();
        ...
        private static IMeatFacility SelectFacility(Farm farm)
        {
            bool doOver;
            do
            {
                ...
                List<IMeatFacility> facilities = new List<IMeatFacility>();
                facilities.AddRange(farm.ChickenHouses);
                facilities.AddRange(farm.DuckHouses);
                facilities.AddRange(farm.GrazingFields);
